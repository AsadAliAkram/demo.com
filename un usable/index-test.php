...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			<div class="product-image"><a href="all-products.php?pid=<?php echo $row["pid"];?>"><img src="<?php echo $product_array[$key]["pimage"]; ?>"></a></div>
			<div><strong><?php echo $product_array[$key]["pname"]; ?></strong></div>
			<div class="product-price"><?php echo "$".$product_array[$key]["preal[rice"]; ?></div>
			<div><input type="number" name="quantity" value="1" size="2" />
